import { FaBath, FaBed, FaCheck, FaMapMarker, FaTimes } from "react-icons/fa";
...
const PropertyDetail = ({ property }) => {
    return (  <main>
          ...
          <div className="flex flex-col md:flex-row justify-around">
            ...
            >
              ...
              <div className="text-2xl font-bold text-blue-500">
                {property.rates.nightly ? (`$${property.rates.nightly.toLocaleString()}`) : ( <FaTimes className="text-red-500" />) }
              </div>
            </div>
            <div
              className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0"
            >
              ...
              <div className="text-2xl font-bold text-blue-500">
                {property.rates.weekly ? (`$${property.rates.weekly.toLocaleString()}`) : ( <FaTimes className="text-red-500" />) }
              </div>
            </div>
            <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
              <div className="text-gray-500 mr-2 font-bold">Monthly</div>
              <div className="text-2xl font-bold text-blue-500">
              {property.rates.monthly ? (`$${property.rates.monthly.toLocaleString()}`) : ( <FaTimes className="text-red-500" />) }
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          >
            {property.amenities.map((ameniti, index)=> (
                 <li key={index}>
